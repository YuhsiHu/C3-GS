...
def train(cfg, network):
    ...
    # make trainer, optimizer, scheduler, recorder, evaluator
    ...
    # load model
    begin_epoch = load_model(network, optimizer, scheduler, recorder, cfg.trained_model_dir, resume=cfg.resume)
