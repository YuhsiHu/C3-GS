...
class Trainer(object):
    ...
    def train(self, epoch, data_loader, optimizer, recorder):
        ...
        for iteration, batch in enumerate(data_loader):
            ...
            batch['step'] = 0
            # train mode, get return from final loss function
            ...
            optimizer.zero_grad()
            loss.backward()
            # limit the max and min gradient values
            ...
            if iteration % cfg.log_interval == 0 or iteration == (max_iter - 1):
                ...
                training_state = '  '.join(['avg_time :{:2f}', 'eta: {}', '{}', 'lr: {:.6f}', 'max_mem: {:.0f}'])
                training_state = training_state.format(recorder.batch_time.global_avg, eta_string, str(recorder), lr, memory)
